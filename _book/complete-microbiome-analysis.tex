...
\hypersetup{
  ...
  pdfauthor={Alana Schick, other authors},
  hidelinks,
...
This is for anyone analysing amplicon sequence data\ldots{}
...
{\centering \includegraphics[width=0.8\linewidth]{complete-microbiome-analysis_files/figure-latex/nice-fig-1} 
...
\hypertarget{part-section-1-name-of-this-section}{%
\part{Section 1: Name of this section}\label{part-section-1-name-of-this-section}}

\hypertarget{dna-extract}{%
\chapter{Extract DNA}\label{dna-extract}}

\hypertarget{library-preparation}{%
\chapter{Library Preparation}\label{library-preparation}}

\hypertarget{choosing-a-region}{%
\section{Choosing a region}\label{choosing-a-region}}
...
\hypertarget{part-section-2-name-of-this-section}{%
\part{Section 2: Name of this section}\label{part-section-2-name-of-this-section}}
...
\chapter{Quality Filtering}\label{quality-filtering}}

\hypertarget{generate-sv-table}{%
\chapter{Generate SV table}\label{generate-sv-table}}

\hypertarget{remove-contaminants}{%
\chapter{Remove Contaminants}\label{remove-contaminants}}

\hypertarget{part-section-3-name-of-this-section}{%
\part{Section 3: Name of this section}\label{part-section-3-name-of-this-section}}
